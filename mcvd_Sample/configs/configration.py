...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='configs/radar_pred.yml', required=False, help='Path to the config file')
    parser.add_argument('--data_path', type=str, default='/data03/wuqiliang/code/mcvd/my/data/path/to/datasets', required=False, help='Path to the dataset')
    parser.add_argument('--seed', type=int, default=3407, help='Random seed')
    parser.add_argument('--exp', type=str, default='exp', required=False, help='Path for saving running related data.')
    ...
    parser.add_argument('-vg', '--video_gen', action='store_true',
                        help='Whether to produce video samples from the conditional model')
    parser.add_argument('-t', '--train', action='store_true',
                        help='Whether to produce video samples from the conditional model')
    parser.add_argument('-vd', '--valid', action='store_true',
                        help='Whether to produce video samples from the conditional model')
